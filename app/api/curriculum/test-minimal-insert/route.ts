...
export async function POST(request: NextRequest) {
  try {
    ...
    const moreFieldsRecord = {
      ...
      content_description: 'Understand that English is one of many languages spoken in Australia',
      elaboration: 'recognising that Australia is a linguistically diverse country',
    ...
    const multipleRecords = [
      {
        ...
        subject: 'Mathematics',
        level: 'Year 1',
        content_description: 'Develop confidence with number sequences to and from 100'
      },
      {
