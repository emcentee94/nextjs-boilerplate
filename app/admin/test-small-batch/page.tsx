      ...
      <div className='max-w-2xl mx-auto px-4'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Test the import process with a small batch (10 rows) to identify
              any database issues.
            </CardDescription>
          </CardHeader>
              ...
              <div className='space-y-4'>
                <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                  ...
                  <div className='text-green-700 space-y-2'>
                    ...
                    <p>
                      <strong>Test Records:</strong> {testResults.test_records}
                    </p>
                    <p>
                      <strong>Insert Result:</strong>{' '}
                      {testResults.insert_result} records
                    </p>
                  </div>
                </div>
                  ...
                  <div className='bg-gray-50 p-4 rounded-lg'>
                    ...
                    <div className='text-sm text-gray-600 space-y-1'>
                      <p>
                        ...
                        {testResults.sample_outcome.learning_area}
                      </p>
                      <p>
                        <strong>Subject:</strong>{' '}
                        {testResults.sample_outcome.subject}
                      </p>
                      <p>
                        <strong>Level:</strong>{' '}
                        {testResults.sample_outcome.level}
                      </p>
                      <p>
                        <strong>Content Description:</strong>{' '}
                        {testResults.sample_outcome.content_description?.substring(
                          0,
                          100
                        )}
                        ...
                      ...
                      <p>
                        ...
                        {testResults.sample_outcome.topics?.join(', ')}
                      </p>
                    </div>
                  </div>
                )}
