      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-gray-600 max-w-2xl mx-auto font-nunito'>
            Quick guides to set up Taughtful and generate your first lessons,
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto'>
          <Card className='shadow-md'>
            <CardHeader>
              ...
              <CardDescription>
                Subject, year level, outcomes, and scaffolds
              </CardDescription>
            </CardHeader>
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Use the dashboard to select a subject and year level, then
                choose curriculum outcomes. Pick trauma-informed supports and
                embed Indigenous perspectives as needed.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='shadow-md'>
            ...
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Toggle your curriculum region in the Curriculum area. Victorian
                teachers can select Version 2.0; others default to AC v9.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='shadow-md'>
            <CardHeader>
              ...
              <CardDescription>
                Adjust duration, supports, and assessment
              </CardDescription>
            </CardHeader>
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Regenerate with different scaffolds, time, and assessment focus.
                Export or copy into your planning docs.
              </p>
            </CardContent>
          </Card>
