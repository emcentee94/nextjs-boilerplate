      ...
      <div className='max-w-4xl mx-auto px-4'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Check the status of your curriculum data import and identify any
              issues.
            </CardDescription>
          </CardHeader>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                  ...
                  <div className='text-yellow-700 space-y-1'>
                    <p>
                      <strong>Expected:</strong> ~21,000 records
                    </p>
                    <p>
                      <strong>Actual:</strong> {stats.total_records} records
                    </p>
                    <p>
                      <strong>Missing:</strong> {21000 - stats.total_records}{' '}
                      records
                    </p>
                    <p>
                      <strong>Completion:</strong>{' '}
                      {((stats.total_records / 21000) * 100).toFixed(1)}%
                    </p>
                  </div>
                </div>
                ...
                {stats.total_records < 10000 && (
                  <div className='bg-red-50 border border-red-200 rounded-lg p-4'>
                    ...
                    <div className='text-red-700 space-y-2'>
                      <p>
                        Your import appears to be incomplete. Possible causes:
                      </p>
                      <ul className='list-disc list-inside ml-4 space-y-1'>
                        <li>
                          Excel file structure doesn't match expected format
                        </li>
                      ...
                      <p className='mt-2'>
                        <strong>Recommendation:</strong> Check your Excel file
                        structure and try re-importing.
                      </p>
                    </div>
                  </div>
                )}
