    ...
    <section className='py-14 px-6 md:px-12 bg-white/60'>
      <div className='max-w-3xl mx-auto text-center mb-10'>
        <h2 className='text-3xl md:text-4xl font-extrabold text-gray-900'>
          Prioritising Cultural Safety in EduTech
        </h2>
        <p className='text-gray-700 mt-3 text-lg'>
          Practical safeguards that respect Country, Culture, and
          Community—built into every lesson.
        </p>
      </div>
          ...
          return (
            ...
            >
              <CardContent className='p-6 flex items-start gap-4'>
                <div
                  className={`shrink-0 rounded-full p-3 ${cc.bg} ${cc.text}`}
                >
                  {it.icon}
                </div>
                <div>
