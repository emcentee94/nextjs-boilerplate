...
export default function TaughtfulSurvey() {
  ...
  const questions = [
    {
      id: 'vibe',
      text: 'First vibe check — Taughtful feels like…',
      options: [
        '🚫 Pointless',
        '🤔 Interesting',
        '👍 Promising',
    ...
    {
      id: 'recommend',
      text: 'Would you tell another teacher about it?',
      options: [
        '🙅‍♀️ No way',
        '🤷 Maybe',
        '☕ Staffroom chat worthy',
        '📢 Absolutely',
      ],
    },
    {
      id: 'excites',
      text: 'Which parts excite you most right now?',
      options: [
        '📚 Lesson generator',
    ...
    {
      id: 'gaps',
      text: 'What feels like the biggest gap?',
      options: [
        '🌀 Needs more depth',
        '🖥 UX feels clunky',
        '🧐 Unsure if I can trust alignment',
        '🤷 Not sure how I’d use it',
        '⚡ Other tools already do this better',
      ],
    },
    {
      id: 'features',
      text: 'If Taughtful added something next, what should it be?',
      options: [
        '📊 PowerPoints',
        '📝 Quizzes',
        '📄 Worksheets',
