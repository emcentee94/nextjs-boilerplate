      ...
      <div className='max-w-4xl mx-auto px-4'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Analyze your Excel file structure to understand why the full
              import might be failing.
            </CardDescription>
          </CardHeader>
              ...
              <div className='space-y-6'>
                <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                  ...
                  <div className='text-green-700 space-y-2'>
                    ...
                    <p>
                      <strong>Type:</strong> {analysis.fileType}
                    </p>
                    <p>
                      <strong>Sheets:</strong> {analysis.sheetCount}
                    </p>
                  </div>
                </div>
                  ...
                  {analysis.sheets.map((sheet: any, index: number) => (
                    <Card key={index} className='bg-gray-50'>
                      <CardHeader>
                        ...
                        <CardDescription>
                          {sheet.nonEmptyRows} non-empty rows out of{' '}
                          {sheet.rowCount} total rows
                        </CardDescription>
                      </CardHeader>
                ...
                <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                  ...
                  <div className='text-yellow-700 text-sm space-y-1 mt-2'>
                    ...
                    <p>
                      ...
                      {analysis.sheets.reduce(
                        (sum: number, sheet: any) => sum + sheet.nonEmptyRows,
                        0
                      )}
                    </p>
                    <p>• Expected import: ~21,000 records</p>
                    <p>
                      • Potential issue: Check if all sheets are being processed
                    </p>
                  </div>
                </div>
              </div>
