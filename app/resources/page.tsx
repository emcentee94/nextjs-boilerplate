  ...
  const featuredResources = [
    {
      ...
      description:
        'Essential overview of all learning areas, general capabilities, and cross-curriculum priorities with year-level progression',
      ...
      highlights: [
        'Complete learning area overview',
        'Year-level progression maps',
        'Achievement standard summaries',
    ...
    },
    {
      ...
      description:
        "Understanding how Taughtful's Retrieval-Augmented Generation creates curriculum-aligned lessons from trusted sources",
      type: 'Educational',
      featured: true,
      external: true,
      duration: '8 minutes',
    ...
    },
    {
      ...
      description:
        'Best practices for culturally responsive teaching, Indigenous perspectives integration, and creating inclusive learning environments',
