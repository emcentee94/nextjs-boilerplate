...
export default function ReviewGenerator() {
  ...
  const pedagogyApproachParam = searchParams.get("pedagogyApproach") || "Trauma-Informed"
  const scaffoldingLevelParam = searchParams.get("scaffoldingLevel") || "Moderate"
  const indigenousPerspectivesParam = searchParams.get("indigenousPerspectives") === "true"
  ...
  const [pedagogyApproach, setPedagogyApproach] = useState(pedagogyApproachParam)
  const [scaffoldingLevel, setScaffoldingLevel] = useState(scaffoldingLevelParam)
  const [indigenousPerspectives, setIndigenousPerspectives] = useState(indigenousPerspectivesParam)
  ...
  }, [authorityParam, versionParam, subjectParam, yearParam, minutesParam, levelParam, selectedStandardsParam, classSizeParam, abilityRangeParam, specialNeedsParam, culturalBackgroundsParam, pedagogyApproachParam, scaffoldingLevelParam, indigenousPerspectivesParam])
      ...
      <div className="min-h-screen w-full bg-[#FDE5DA] text-[#333]">
        <div className="max-w-4xl mx-auto px-6 py-6 lg:py-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-[#666] mb-6">Your personalized lesson plan is ready for review.</p>
            ...
            <div className="mt-6">
              <a href="/dashboard" className="text-sm text-[#888625] hover:underline">
                ← Back to Dashboard
              </a>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 lg:py-8">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-[70vh]">
            ...
            <div className="relative">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#666]">Review your selections and generate your lesson plan.</p>
                </div>
              </div>

              <div className="space-y-4">
                <div className="rounded-xl border p-4 bg-[#F7FBF3] border-[#CBD5C0]">
                  <div className="text-xs text-[#666] mb-2 font-semibold">Lesson Overview</div>
                ...
                <div className="rounded-xl border p-4 bg-white">
                  <div className="text-xs text-[#666] mb-2 font-semibold">Curriculum Alignment</div>
                  <div className="text-sm">
                    <div className="font-semibold">
                      {authority === "ACARA" ? "ACARA v9 (AU)" : authority === "VCAA" ? "VCAA (VIC)" : authority === "NESA" ? "NESA (NSW)" : authority === "QCAA" ? "QCAA (QLD)" : "SCSA (WA)"}
                    </div>
                ...
                <div className="rounded-xl border p-4 bg-white">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-[#666] mt-1">
                      {scaffoldingLevel} scaffolding • {indigenousPerspectives ? "Indigenous perspectives included" : "Standard approach"}
                    </div>
                  </div>
                </div>

                <div className="rounded-xl border p-4 bg-white">
                  <div className="text-xs text-[#666] mb-2 font-semibold">Class Profile</div>
                  <div className="text-sm">
                    <div className="font-semibold">{abilityRange} ability range</div>
                    <div className="text-[#666] mt-1">
                      {specialNeeds.length > 0 && `${specialNeeds.length} special needs • `}
                      {culturalBackgrounds.length > 0 && `${culturalBackgrounds.length} cultural backgrounds`}
                      {specialNeeds.length === 0 && culturalBackgrounds.length === 0 && "Standard class profile"}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 flex flex-col border border-[#EFEFEF] h-full">
            ...
            <div className="space-y-4">
              <div className="rounded-xl border p-4 bg-[#F7FBF3] border-[#CBD5C0]">
                <div className="text-xs text-[#666] mb-2 font-semibold">What You'll Get</div>
                <ul className="list-disc ml-5 text-sm leading-6">
                  ...
                  {indigenousPerspectives && <li>Indigenous perspectives integrated throughout</li>}
                </ul>
              </div>

              <div className="rounded-xl border p-4 bg-white">
                <div className="text-xs text-[#666] mb-2 font-semibold">Personalization Features</div>
                <ul className="list-disc ml-5 text-sm leading-6">
                  ...
                  {culturalBackgrounds.length > 0 && <li>Culturally respectful content</li>}
                </ul>
              </div>

              <div className="rounded-xl border p-4 bg-white">
                <div className="text-xs text-[#666] mb-2 font-semibold">Export Options</div>
            ...
            <div className="mt-5 flex items-center justify-between flex-wrap gap-3">
              <div className="text-xs text-[#666]">Tip: You can always edit the generated plan.</div>
            </div>
