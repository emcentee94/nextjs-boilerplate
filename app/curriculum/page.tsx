      ...
      <div className="container mx-auto px-4 py-8">
            ...
            {curriculumHighlights.map((highlight, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-fredoka">{highlight.title}</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow cursor-pointer group">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg font-fredoka">{action.title}</CardTitle>
                      <CardDescription className="font-nunito">
                        {action.description}
                      </CardDescription>
                    </div>
                ...
                <CardContent>
                  <Button variant="outline" className="w-full group-hover:bg-[#FD6585] group-hover:text-white group-hover:border-[#FD6585] transition-colors">
                    Explore
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 font-nunito mt-2">
                The 8 learning areas that form the foundation of the Australian Curriculum
              </p>
            </div>
        ...
        <div className="mt-16 text-center bg-white rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-gray-600 mb-6 font-nunito max-w-2xl mx-auto">
            Use Taughtful's RAG-powered AI to generate lesson plans that perfectly align 
            with Australian Curriculum v9 standards.
          </p>
