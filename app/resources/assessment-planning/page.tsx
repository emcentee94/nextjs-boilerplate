      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-gray-600 max-w-2xl mx-auto font-nunito'>
            Scope‑and‑sequence mapping, outcome selection, and clear success
            criteria linked to standards.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto'>
          <Card className='shadow-md'>
            ...
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Select content descriptions and view the linked achievement
                standards. Build success criteria straight from the language of
                the standard.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='shadow-md'>
            ...
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Use quick checks, exit tickets, and conferencing to adjust
