      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-gray-600 max-w-2xl mx-auto font-nunito'>
            Guidance to keep students regulated and safe, and teachers
            supported.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto'>
          ...
          <Card className='shadow-md'>
            ...
            <CardContent className='text-sm text-gray-700 space-y-2'>
              <p>
                Template comms, referral pathways, and self‑care check‑ins that
                are sustainable during term time.
              </p>
            </CardContent>
          </Card>
