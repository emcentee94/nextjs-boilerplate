...
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtwZHVzYmhxaXN3ZGl5emR3eHB3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODYwNTEzNCwiZXhwIjoyMDc0MTgxMTM0fQ.6IZdZbWpuZw87Va0zqmuZgBVvVwqf0RnwjZDwNcchTY';

const supabase = createClient(supabaseUrl, supabaseServiceKey);

async function uploadFiles() {
  console.log('🚀 Starting upload with service role (bypasses RLS)...\n');
