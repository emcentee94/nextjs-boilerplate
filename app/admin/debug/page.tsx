      ...
      <div className="max-w-4xl mx-auto px-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Analyze your Excel file structure to understand why the import might be failing.
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-4">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <div className="text-green-700 space-y-2">
                    <p><strong>File:</strong> {debugInfo.file_name}</p>
                    <p><strong>Size:</strong> {(debugInfo.file_size / 1024 / 1024).toFixed(2)} MB</p>
                    <p><strong>Type:</strong> {debugInfo.file_type}</p>
                    <p><strong>Sheets:</strong> {debugInfo.sheet_names.length}</p>
                  </div>
                </div>

                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium text-gray-900 mb-2">Sheet Names:</h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    {debugInfo.sheet_names.map((sheet: string, index: number) => (
                    ...
                    <div className="space-y-3">
                      ...
                      {sheet.sample_rows.length > 0 && (
                        <div>
                          ...
                          {sheet.sample_rows.map((row: any[], rowIndex: number) => (
                            <div key={rowIndex} className="text-sm text-gray-600 bg-gray-50 p-2 rounded mb-1">
