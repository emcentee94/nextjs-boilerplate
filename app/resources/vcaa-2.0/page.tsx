    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFF7ED] via-white to-[#FFF2E8]">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-14">
          ...
          <h1 className="text-5xl font-black font-fredoka text-gray-900 mb-4">VCAA (2.0) Knowledge Hub</h1>
        ...
        <div className="max-w-6xl mx-auto mb-10">
          <div className="bg-white/90 border-4 border-[#FD6585]/20 rounded-3xl shadow-2xl p-8 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-black font-fredoka mb-2">Taughtful Alignment</h2>
            <p className="text-muted-foreground font-nunito mb-6">How Taughtful operationalises VC2.0 for real classrooms</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div className="bg-gradient-to-r from-[#FD6585]/10 to-[#FF9A2E]/10 rounded-2xl p-4 border-2 border-[#FD6585]/20">
                <p className="text-sm text-gray-800"><span className="font-semibold">Curriculum mapping:</span> lessons tagged to learning area, level, content description and achievement standard</p>
              </div>
              <div className="bg-gradient-to-r from-[#8E2DE2]/10 to-[#4A00E0]/10 rounded-2xl p-4 border-2 border-[#8E2DE2]/20">
                <p className="text-sm text-gray-800"><span className="font-semibold">Capabilities embedding:</span> auto‑suggested links with evidence statements</p>
              </div>
              <div className="bg-gradient-to-r from-[#00C6FF]/10 to-[#0072FF]/10 rounded-2xl p-4 border-2 border-[#00C6FF]/20">
                <p className="text-sm text-gray-800"><span className="font-semibold">Foundational skills:</span> templates surface literacy/numeracy/digital literacy opportunities</p>
              </div>
              <div className="bg-gradient-to-r from-[#22C55E]/10 to-[#16A34A]/10 rounded-2xl p-4 border-2 border-[#22C55E]/20">
                <p className="text-sm text-gray-800"><span className="font-semibold">Assessment alignment:</span> success criteria from standards; formative + summative checklists</p>
              </div>
              <div className="md:col-span-2 bg-gradient-to-r from-[#FF6CAB]/10 to-[#7366FF]/10 rounded-2xl p-4 border-2 border-[#FF6CAB]/20">
                <p className="text-sm text-gray-800"><span className="font-semibold">Equity & inclusion:</span> supports Foundation Levels A–D and EAL pathways with adapted exemplars</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <Card className="shadow-md text-center">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="font-black">Curriculum Overview</CardTitle>
                  <CardDescription className="font-semibold">Design principles and structure</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="font-semibold">Eight disciplines</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="font-semibold">Cross-disciplinary development</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-md text-center">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="font-black">Achievement Standards</CardTitle>
                  <CardDescription className="font-semibold">Progression and assessment</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-md text-center">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="font-black">Foundational Skills</CardTitle>
                  <CardDescription className="font-semibold">Digital Literacy, Literacy, Numeracy</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-md text-center">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="font-black">Cross‑Curriculum Priorities</CardTitle>
                  <CardDescription className="font-semibold">Perspectives and organising ideas</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-md lg:col-span-2 text-center">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="font-black">Implementation Guidance</CardTitle>
                  <CardDescription className="font-semibold">Practical strategies</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
