-- Taughtful Supabase Database Setup
...
CREATE INDEX IF NOT EXISTS idx_curriculum_learning_area_subject ON public.curriculum_data(learning_area, subject);
CREATE INDEX IF NOT EXISTS idx_curriculum_level ON public.curriculum_data(level);
CREATE INDEX IF NOT EXISTS idx_curriculum_topics_gin ON public.curriculum_data USING GIN(topics);
...
CREATE INDEX IF NOT EXISTS idx_lesson_plans_subject_level ON public.lesson_plans(learning_area, subject, year_level);
