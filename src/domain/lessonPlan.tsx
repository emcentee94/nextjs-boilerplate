...
export function isLessonPlan(x: any): x is LessonPlan {
  ...
  for (const tb of x.lessonTimeline) {
    if (
      !tb ||
      typeof tb.minutes !== 'number' ||
      typeof tb.activity !== 'string'
    )
      return false
  }
  return true
...
export const exampleCellsAndSystems: LessonPlan = createLessonPlan({
  ...
  linkedCurriculum: [
    {
      code: 'AC9S8U01',
      description:
        'Compare plant and animal cells and explain how the structures of cells relate to their functions',
    },
    {
      code: 'AC9S8U02',
      description:
        'Analyse the relationship between structure and function at cell, tissue and organ level',
    },
  ],
  lessonTimeline: [
    {
  ...
  indigenousPerspectives:
    'This lesson incorporates Aboriginal and Torres Strait Islander perspectives on living systems, recognizing the deep connection between Indigenous knowledge and scientific understanding of cellular organization.',
  ...
  notesForTeacher:
    'This lesson is designed to be culturally responsive and trauma-informed. Be prepared to adapt activities based on student needs and responses. Have backup activities ready for students who need additional support or challenge.',
  complianceSummary:
    'This lesson addresses AC9S8U01 and AC9S8U02, incorporating Indigenous perspectives and trauma-informed strategies to support diverse learners in understanding cell structure and function.',
})
