              ...
              <div className='flex items-center gap-3 mb-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-[#666]'>
                    Start with the building blocks of your lesson.
                  </p>
                </div>
              </div>
                  ...
                  {showCurriculumInfo && (
                    <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Learning Areas:</strong> 8 core subjects
                          (English, Maths, Science, etc.)
                        </div>
                        <div>
                          • <strong>General Capabilities:</strong> 7 essential
                          skills (Literacy, Numeracy, ICT, etc.)
                        </div>
                        <div>
                          • <strong>Cross-Curriculum Priorities:</strong> 3 key
                          contexts (Indigenous, Asia, Sustainability)
                        </div>
                        <div>
                          • <strong>Achievement Standards:</strong> Assessment
                          criteria for each year level
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    {showVersionInfo && (
                      <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                        ...
                        <div className='space-y-1 text-[#666]'>
                          <div>
                            • <strong>New Features:</strong> Enhanced content
                            descriptions and achievement standards
                          </div>
                          <div>
                            • <strong>Foundation A–D:</strong> Inclusive levels
                            for students with additional needs
                          </div>
                          <div>
                            • <strong>EAL Support:</strong> Dedicated English as
                            Additional Language curriculum
                          </div>
                          <div>
                            • <strong>Implementation:</strong> Phased rollout
                            from 2024-2026
                          </div>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    {showLevelInfo && (
                      <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                        ...
                        <div className='space-y-1 text-[#666]'>
                          <div>
                            • <strong>Standard:</strong> Regular curriculum
                            expectations for most students
                          </div>
                          {showFoundationAD && (
                            <div>
                              • <strong>Foundation A–D:</strong> Inclusive
                              levels for students with intellectual disabilities
                              or learning delays
                            </div>
                          )}
                          <div>
                            • <strong>Differentiation:</strong> Allows for
                ...
                <div>
                  ...
                  {showSubjectInfo && (
                    <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>English:</strong> Language, Literature,
                          Literacy strands
                        </div>
                        <div>
                          • <strong>Mathematics:</strong> Number, Algebra,
                          Measurement, Statistics
                        </div>
                        <div>
                          • <strong>Science:</strong> Understanding, Inquiry
                          Skills, Human Endeavour
                        </div>
                        <div>
                          • <strong>HASS:</strong> History, Geography, Civics,
                          Economics
                        </div>
                        <div>
                          • <strong>Plus:</strong> Arts, Technologies, Health &
                          PE, Languages
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  {showYearInfo && (
                    <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Foundation (F):</strong> Ages 5-6,
                          foundational skills
                        </div>
                        <div>
                          • <strong>Years 1-2:</strong> Early primary, building
                          basics
                        </div>
                        <div>
                          • <strong>Years 3-4:</strong> Middle primary,
                          developing skills
                        </div>
                        <div>
                          • <strong>Years 5-6:</strong> Upper primary,
                          consolidating
                        </div>
                        <div>
                          • <strong>Years 7-10:</strong> Secondary, extending
                          and applying
                        </div>
                      </div>
                    </div>
              ...
              <div className='mt-6'>
                ...
                {showDurationInfo && (
                  <div className='mt-2 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                    ...
                    <div className='space-y-1 text-[#666]'>
                      <div>
                        • <strong>10-20 mins:</strong> Quick activities,
                        warm-ups, transitions
                      </div>
                      <div>
                        • <strong>30-45 mins:</strong> Standard lesson length
                        for most activities
                      </div>
                      <div>
                        • <strong>60-90 mins:</strong> Extended lessons,
                        projects, investigations
                      </div>
                      <div>
                        • <strong>90+ mins:</strong> Double periods, complex
                        tasks, assessments
                      </div>
                    </div>
                  </div>
                ...
                <div className='mt-3'>
                  <div className='relative'>
                    <div className='mb-1 text-xs font-semibold text-[#888625]'>
                      Lesson Duration
                    </div>
                    <input
                      type='range'
              ...
              <div className='mt-3 flex flex-wrap items-center gap-3'>
                {saveMsg && (
                  <div className='text-sm px-3 py-2 rounded bg-[#F0FFF4] text-[#166534] border border-[#BBF7D0]'>
                    {saveMsg}{' '}
                    <a href='/my-plans' className='underline'>
                      Open My Plans
                    </a>
                  </div>
                )}
          ...
          <div className='bg-white rounded-2xl shadow-xl p-6 lg:p-8 flex flex-col border border-[#EFEFEF] h-full'>
              ...
              <ul className='space-y-2 text-sm'>
                <li className='flex items-start gap-2'>
                  ...
                  <span className='flex-1'>
                    Focus skill selected from curriculum (prefilled by
                ...
                <li className='flex items-start gap-2'>
                  ...
                  <span className='flex-1'>
                    Corresponding achievement standard(s) auto-linked
                  </span>
                </li>
              </ul>
              <a
                href={curriculumQuery}
                className='mt-3 inline-block text-xs font-semibold text-[#888625] underline'
              >
                View in Curriculum
              </a>
            </div>
            ...
            <div className='rounded-xl border p-4 bg-white'>
              ...
              <ul className='list-disc ml-5 text-sm leading-6'>
                <li>
                  Aligned to selected curriculum (VCAA / NESA / QCAA / SCSA /
                  ACARA v9)
                </li>
                <li>Trauma-informed entry routine & choice-based tasks</li>
                <li>
                  Culturally respectful hooks; VCAA 2.0 English enables
                  Foundation A–D scaffolds
                </li>
            ...
            <div className='mt-5 flex items-center justify-between flex-wrap gap-3'>
              <div className='text-xs text-[#666]'>
                Tip: Your choices update the scaffold in real time.
              </div>
            </div>
