...
export const LEARNING_AREAS: LearningArea[] = [
  ...
  },
  {
    ...
    overview:
      "The F–10 Australian Curriculum identifies and organises essential knowledge, understandings and skills in 8 learning areas.",
    subjects: [{ name: "Health and Physical Education", slug: "health-and-physical-education" }],
  },
  {
...
export function getSubjectBySlug(slug: string): { area: LearningArea; subject: Subject } | undefined {
