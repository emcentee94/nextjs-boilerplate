              ...
              <div className='flex items-center gap-3 mb-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-[#666]'>
                    Tell us about your students to personalize the lesson.
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-6'>
                  ...
                  {showClassSizeInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Small (15-20):</strong> More individual
                          attention, detailed activities
                        </div>
                        <div>
                          • <strong>Medium (21-30):</strong> Balanced group work
                          and individual tasks
                        </div>
                        <div>
                          • <strong>Large (30+):</strong> Structured group
                          activities, clear routines
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div>
                  ...
                  {showAbilityInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Mixed:</strong> Tiered activities, flexible
                          grouping
                        </div>
                        <div>
                          • <strong>Above Average:</strong> Extension tasks,
                          higher-order thinking
                        </div>
                        <div>
                          • <strong>Below Average:</strong> Additional
                          scaffolding, visual supports
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div>
                  ...
                  {showInclusiveInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs relative'>
                      ...
                      <div className='font-semibold text-[#888625] mb-1'>
                        Inclusive Teaching (applies to all lessons)
                      </div>
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Universal Design:</strong> Accessible for
                          all learners
                        </div>
                        <div>
                        ...
                        <div>
                          • <strong>Cultural Safety:</strong> Respectful of all
                          backgrounds
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  <label className='text-xs uppercase tracking-wide text-[#666] font-semibold mb-2 block'>
                    Learner Profiles (select any that apply for planning
                    supports)
                  </label>
                  <div className='grid grid-cols-1 gap-2'>
                    {learnerProfileOptions.map((profile) => (
                      <label
                        key={profile}
                        className='flex items-center gap-2 p-2 rounded-lg border bg-white hover:bg-[#fff8] cursor-pointer transition-colors'
                      >
                        <input
                          type='checkbox'
          ...
          <div className='bg-white rounded-2xl shadow-xl p-6 lg:p-8 flex flex-col border border-[#EFEFEF] h-full'>
                ...
                <div className='rounded-xl border p-4 bg-white'>
                  ...
                  <div className='flex flex-wrap gap-1'>
                    {specialNeeds.map((need) => (
                      <span
                        key={need}
                        className='text-xs px-2 py-1 rounded-full bg-[#FD6585]/10 text-[#FD6585] border border-[#FFD1DC]'
                      >
                        {need}
                      </span>
                    ))}
            ...
            <div className='mt-5 flex items-center justify-between flex-wrap gap-3'>
              <div className='text-xs text-[#666]'>
                Tip: More details = better personalization.
              </div>
            </div>
