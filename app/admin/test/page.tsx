      ...
      <div className='max-w-2xl mx-auto px-4'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Test the Supabase connection and database schema to identify any
              issues.
            </CardDescription>
          </CardHeader>
                ...
                {testResults.success ? (
                  <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                    ...
                    <div className='text-green-700 space-y-2'>
                      ...
                      <p>
                        <strong>Insert Capability:</strong>{' '}
                        {testResults.insert_capability}
                      </p>
                    </div>
                  </div>
                ) : (
