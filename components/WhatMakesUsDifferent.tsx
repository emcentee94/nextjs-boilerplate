  ...
  return (
    <section className='relative overflow-hidden bg-gradient-to-b from-[#FDE5DA] via-[#FDE5DA]/70 to-white py-20'>
      ...
      <div className='pointer-events-none absolute inset-0'>
        <svg
          className='absolute -top-10 left-10 h-24 w-24 opacity-20'
          viewBox='0 0 100 100'
          fill='currentColor'
        >
        ...
        <svg
          className='absolute bottom-10 right-6 h-16 w-16 opacity-20'
          viewBox='0 0 100 100'
          fill='currentColor'
        >
      ...
      <div className='container mx-auto max-w-6xl px-6'>
        ...
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <p className='mx-auto mt-4 max-w-2xl text-[#333]/80 font-nunito'>
            Most AI tools generate text from patterns — quick, but not always
            accurate, safe, or aligned with what classrooms need. Taughtful is
            different.{' '}
            <span className='font-semibold'>
              We have incorporated RAG — Retrieval‑Augmented Generation.
            </span>
          </p>
          <p className='mx-auto mt-2 max-w-2xl text-[#333]/80 font-nunito'>
            Before creating a lesson scaffold, our AI retrieves from{' '}
            <span className='font-semibold'>
              vetted curriculum and pedagogy resources
            </span>{' '}
            instead of random internet text. The result: outputs you can trust —
            aligned, responsible, and ready to use in Australian classrooms.
          </p>
        </div>
          ...
          <div className='relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg ring-1 ring-black/5 sm:p-8'>
            <div className='flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between'>
              <div className='max-w-3xl'>
                <h3 className='text-xl font-bold text-[#333] font-fredoka'>
                  What does RAG mean?
                </h3>
                ...
                <ul className='mt-3 list-disc space-y-1 pl-5 text-[#333]/80 font-nunito'>
                  <li>
                    <span className='font-medium'>
                      Finds the right book first
                    </span>{' '}
                    (retrieves vetted sources)
                  </li>
                  <li>
                    <span className='font-medium'>
                      Then helps the AI write from it
                    </span>{' '}
                    (generation that's accurate, safe, and culturally
                    respectful)
                  </li>
                </ul>
              </div>
              <div className='w-full max-w-sm flex-shrink-0'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='rounded-xl border border-black/10 p-4 text-center'>
                    <p className='text-sm font-semibold text-[#333] font-fredoka'>
                      Without RAG
                    </p>
                    <p className='mt-2 text-xs text-[#333]/70 font-nunito'>
                      AI guesses from patterns
                    </p>
                  </div>
            ...
            <div className='mt-6 flex flex-wrap items-center gap-3'>
              <a
                href='#beta'
                className='rounded-full bg-[#FD6585] px-5 py-2 text-sm font-semibold text-white shadow hover:opacity-95 font-fredoka'
              >
                Join Free Beta
              </a>
              <span className='text-xs text-[#333]/60 font-nunito'>
                AI you can trust because it's built for Australian classrooms.
              </span>
            </div>
          </div>
        </div>
...
function Pillar({
  ...
  return (
    <div className='group relative rounded-2xl bg-white p-6 shadow-md ring-1 ring-black/5 transition hover:-translate-y-0.5 hover:shadow-lg'>
      <div
        className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full ${color} text-white shadow`}
      >
        {icon}
      </div>
