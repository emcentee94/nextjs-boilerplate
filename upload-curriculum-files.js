...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtwZHVzYmhxaXN3ZGl5emR3eHB3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg2MDUxMzQsImV4cCI6MjA3NDE4MTEzNH0.i5Zr4pKkbqRMiIaYO0yZflkgwKv2qPI5EBj6nQPmR5I';
...
async function uploadFiles() {
  ...
  for (const file of filesToUpload) {
    try {
      ...
      if (error) {
        console.error(`❌ Upload failed for ${file.description}:`, error.message);
        continue;
      }

      console.log(`✅ Successfully uploaded ${file.description}`);
      console.log(`   📍 Path: ${file.bucketPath}`);
      console.log(`   🔗 URL: ${supabaseUrl}/storage/v1/object/public/V9%20CURRISULUM1/${encodeURIComponent(file.bucketPath)}`);
      console.log('');
