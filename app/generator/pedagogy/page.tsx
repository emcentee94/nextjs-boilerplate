        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-[70vh]'>
              ...
              <div className='flex items-center gap-3 mb-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-[#666]'>
                    Choose your teaching approach and support level.
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-6'>
                  ...
                  {showPedagogyInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Trauma-Informed:</strong> Safe, predictable,
                          choice-based learning
                        </div>
                        <div>
                          • <strong>Inquiry-Based:</strong> Student-driven
                          questions and discovery
                        </div>
                        <div>
                          • <strong>Direct Instruction:</strong> Explicit
                          teaching with clear steps
                        </div>
                        <div>
                          • <strong>Collaborative:</strong> Group work and peer
                          learning
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  <div className='flex items-center gap-2 mb-2'>
                    ...
                    <button
                      onClick={() =>
                        setShowScaffoldingInfo(!showScaffoldingInfo)
                      }
                      className='w-4 h-4 rounded-full bg-[#888625]/20 text-[#888625] text-xs font-bold hover:bg-[#888625]/30 transition-colors'
                      title="What's this?"
                    >
                  ...
                  {showScaffoldingInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Minimal:</strong> Independent work with
                          basic guidance
                        </div>
                        <div>
                          • <strong>Moderate:</strong> Balanced support and
                          independence
                        </div>
                        <div>
                          • <strong>Extensive:</strong> High support with
                          step-by-step guidance
                        </div>
                        <div>
                          • <strong>Adaptive:</strong> Adjusts based on student
                          needs
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  {showIndigenousInfo && (
                    <div className='mb-3 p-3 rounded-lg bg-[#F7FBF3] border border-[#CBD5C0] text-xs'>
                      ...
                      <div className='space-y-1 text-[#666]'>
                        <div>
                          • <strong>Respectful:</strong> Authentic Indigenous
                          perspectives and knowledge
                        </div>
                        <div>
                          • <strong>Inclusive:</strong> Connects to local
                          Aboriginal and Torres Strait Islander cultures
                        </div>
                        <div>
                          • <strong>Meaningful:</strong> Goes beyond tokenistic
                          inclusion
                        </div>
                        <div>
                          • <strong>Collaborative:</strong> Works with local
                  ...
                  <label className='flex items-center gap-3 p-3 rounded-lg border bg-white hover:bg-[#fff8] cursor-pointer transition-colors'>
                    <input
                      ...
                      onChange={(e) =>
                        setIndigenousPerspectives(e.target.checked)
                      }
          ...
          <div className='bg-white rounded-2xl shadow-xl p-6 lg:p-8 flex flex-col border border-[#EFEFEF] h-full'>
            ...
            <div className='space-y-4'>
              <div className='rounded-xl border p-4 bg-[#F7FBF3] border-[#CBD5C0]'>
                ...
                <div className='text-xs text-[#666] mt-1'>
                  {pedagogyApproach === 'Trauma-Informed' &&
                    'Safe, predictable learning with student choice'}
                  {pedagogyApproach === 'Inquiry-Based' &&
                    'Student-driven questions and discovery'}
                  {pedagogyApproach === 'Direct Instruction' &&
                    'Explicit teaching with clear steps'}
                  {pedagogyApproach === 'Collaborative Learning' &&
                    'Group work and peer learning'}
                  {pedagogyApproach === 'Differentiated Instruction' &&
              ...
              <div className='rounded-xl border p-4 bg-white'>
                ...
                <div className='text-xs text-[#666] mt-1'>
                  {scaffoldingLevel === 'Minimal' &&
                    'Independent work with basic guidance'}
                  {scaffoldingLevel === 'Moderate' &&
                    'Balanced support and independence'}
                  {scaffoldingLevel === 'Extensive' &&
                    'High support with step-by-step guidance'}
                  {scaffoldingLevel === 'Adaptive' &&
                    'Adjusts based on student needs'}
                </div>
              </div>
              ...
              {indigenousPerspectives && (
                <div className='rounded-xl border p-4 bg-white'>
                  ...
                  <div className='text-sm font-semibold text-[#888625]'>
                    Indigenous Perspectives Included
                  </div>
                  <div className='text-xs text-[#666] mt-1'>
                    Authentic Aboriginal and Torres Strait Islander knowledge
            ...
            <div className='mt-5 flex items-center justify-between flex-wrap gap-3'>
              <div className='text-xs text-[#666]'>
                Tip: Your choices shape the entire lesson structure.
              </div>
            </div>
