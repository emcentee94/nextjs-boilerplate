    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F0FFF4] via-white to-[#E8FFF7]">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2 font-fredoka">Teaching Strategies</h1>
          <p className="text-gray-600 max-w-2xl mx-auto font-nunito">Practical, evidence‑based strategies you can apply tomorrow, with built‑in differentiation and wellbeing.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>Regulation, routine, relationships</CardDescription>
            </CardHeader>
          ...
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>Light / Balanced / Full scaffolds</CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-gray-700 space-y-2">
              <p>Adjust inputs, outputs, time, and supports. Pair with formative checks to move students within their ZPD.</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>Generate a plan with selected strategies</CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
